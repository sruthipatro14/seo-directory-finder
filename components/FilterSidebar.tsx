  ...
  return (
    <label htmlFor={id} className="flex items-start gap-3 cursor-pointer group">
      <div className="relative mt-0.5">
        ...
        />
        <div className="w-4 h-4 rounded border border-zinc-300 dark:border-zinc-600 bg-white dark:bg-zinc-800 peer-checked:bg-blue-600 peer-checked:border-blue-600 transition-colors" />
        <svg
      ...
      <div className="flex flex-col">
        <span className="text-sm text-zinc-700 dark:text-zinc-300 group-hover:text-zinc-900 dark:group-hover:text-zinc-100 transition-colors leading-tight">
          {label}
        </span>
        {sublabel && (
          <span className="text-xs text-zinc-400 dark:text-zinc-500 mt-0.5">{sublabel}</span>
        )}
      </div>
    </label>
  );
...
export default function FilterSidebar({ onFilterChange }: FilterSidebarProps) {
  ...
  return (
    <aside className="w-full rounded-2xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 overflow-hidden shadow-sm">
      {/* Header */}
        ...
        <div>
          ...
          <div className="relative">
            <select
              ...
              className="w-full appearance-none rounded-lg border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-900 px-3 py-2.5 pr-8 text-sm text-zinc-700 dark:text-zinc-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent cursor-pointer transition-colors"
            >
              {INDUSTRIES.map((ind) => (
